...
class AutoAction:
    ...
    def set_carpose(self):#���ݶ�λ��ά���������λ��
        ...
        while tag.z>0.58+0.01 or tag.z<0.58-0.01:
            if tag.z>0.58+0.01:
                self.robot.step_go(0.01)
                time.sleep(0.5)
            if tag.z<0.58-0.01:
                self.robot.step_back(0.01)
                time.sleep(0.5)
            print("tag.z: %f" % tag.z)
            time.sleep(4)
        print("tag.z: %f" % tag.z)
